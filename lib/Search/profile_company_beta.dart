...
class ProfileScreenBeta extends StatefulWidget {
  final String userID;
  const ProfileScreenBeta({required this.userID});

  @override
  State<ProfileScreenBeta> createState() => _ProfileScreenBetaState();
}

class _ProfileScreenBetaState extends State<ProfileScreenBeta> {
