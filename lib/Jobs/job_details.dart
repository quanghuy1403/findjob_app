...
import 'package:findjob_app/Search/edit_job.dart';
                                  ...
                                  TextButton(
                                    onPressed: () {
                                      Navigator.pushReplacement(
                                        context,
                                        MaterialPageRoute(
                                          builder: (_) => ProfileScreenBeta(userID: widget.userID),
                                        ),
                                      );
                                    },
                                    child: Padding(
                                      padding: const EdgeInsets.only(right: 40.0), // Thêm padding bên trái
                                      child: Text(
                                        authorName ?? '',
                                        style: const TextStyle(
                                          fontWeight: FontWeight.bold,
